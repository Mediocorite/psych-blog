...
export default function Home() {
  return (
    <div>
      {/*Header*/}
      <div
        className="m-0 w-full bg-cover bg-bottom p-0"
        style={{
      ...
      {/*Container*/}
      <div className="container mx-auto -mt-32 max-w-6xl px-4 md:px-0">
        <div className="mx-0 sm:mx-6">
          ...
          <div className="container mt-8 rounded bg-green-100 p-4 text-center font-sans md:p-24">
            <h2 className="break-normal text-2xl font-bold md:text-4xl">
              Subscribe to Ghostwind CSS
            </h2>
            <h3 className="break-normal text-base font-bold font-normal text-gray-600 md:text-xl">
          ...
          <div className="flex w-full items-center p-8 font-sans md:p-24">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-600 md:text-base">
                ...
                <a
                  className="border-b-2 border-green-500 text-gray-800 no-underline hover:text-green-500"
